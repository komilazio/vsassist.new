...
theme.set_highlights = function(opts)
    ...
    hl(0, "MatchParen", { fg = c.vscRed, bg = c.vscGreenNew })
    ...
    hl(0, "Pmenu", { fg = c.vscPopupFront, bg = c.vscBack })
    hl(0, "PmenuSel", {
    ...
    hl(0, "StatusLine", { fg = c.vscFront, bg = c.vscBack })
    ...
    hl(0, "Comment", { fg = c.vscComment, bg = "NONE", italic = opts.italic_comments })
    ...
    hl(0, "Operator", { fg = c.gruvFg3, bg = "NONE" })
    hl(0, "Keyword", { fg = c.vsaGold, bg = "NONE" })
    ...
    hl(0, "Type", { fg = c.gruvFg1, bg = "NONE" })
    hl(0, "StorageClass", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "Structure", { fg = c.gruvFg1, bg = "NONE" })
    hl(0, "Typedef", { fg = c.gruvFg1, bg = "NONE" })
    ...
    hl(0, "@parameter", { fg = c.gruvFg3, bg = "NONE" })
    ...
    hl(0, "@label", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@keyword", { fg = c.vsaGold, bg = "NONE" })
    hl(0, "@keyword.function", { fg = c.vsaGold, bg = "NONE" })
    hl(0, "@keyword.operator", { fg = c.vsaGold, bg = "NONE" })
    hl(0, "@keyword.coroutine", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@keyword.return", { fg = c.gruvPurple, bg = "NONE" })
    hl(0, "@operator", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@exception", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@type", { fg = c.gruvFg1, bg = "NONE" })
    ...
    hl(0, "@definition.parameter", { fg = c.gruvFg3, bg = "NONE" })
    ...
    --
        -- Pmenu
        hl(0, "Pmenu", { fg = "NONE", bg = c.vscBack })
...
theme.link_highlight = function()
    ...
    -- hl(0, "@lsp.type.function.call", { link = "@function.call"})
